...
import {TableHeader, TableHeaderProperties} from '../server/modules/table/models/tableHeader.model';
import {TableRow, TableRowProperties} from '../server/modules/table/models/tableRow.model';
import {populateTable} from './utilities/modules/table/populateTable';
import {TableProperties} from '../server/modules/table/models/table.model';
