...
export var AsyncActionStatus;
(function (AsyncActionStatus) {
    AsyncActionStatus["UNSTARTED"] = "UNSTARTED";
    AsyncActionStatus["STARTED"] = "STARTED";
    AsyncActionStatus["SUCCEEDED"] = "SUCCEEDED";
    AsyncActionStatus["FAILED"] = "FAILED";
})(AsyncActionStatus || (AsyncActionStatus = {}));
function startedAsyncAction(type) {
    return {
        type: type,
        status: AsyncActionStatus.STARTED,
    };
}
function succeededAsyncAction(type, payload, params) {
    return {
        type: type,
...
function failedAsyncAction(type, error, params) {
    return {
        type: type,
...
export function asyncActionCreator(type, action, params) {
    var _this = this;
    return function (dispatch) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    dispatch(failedAsyncAction(type, error_1));
                    throw error_1;
